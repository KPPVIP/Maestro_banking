...
function playAnim(animDict, animName, duration)
	...
	while not HasAnimDictLoaded(animDict) do Citizen.Wait(15) end
...
RegisterNUICallback('einzahlntriggerhuensohn', function(data)
	TriggerServerEvent('bank:einzahlntriggerhuensohn', tonumber(data.amount))
	TriggerServerEvent('bank:balance')
end)

RegisterNUICallback('withdrawtriggerhuensohnl', function(data)
	TriggerServerEvent('bank:withdrawtriggerhuensohn', tonumber(data.amountw))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('transfertriggerhuensohn', function(data)
	TriggerServerEvent('bank:transfertriggerhuensohn', data.to, data.amountt)
	TriggerServerEvent('bank:balance')
end)
